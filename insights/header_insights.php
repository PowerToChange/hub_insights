    ...
    <div class="row">
      ...
      <div class="col-md-3 col-sm-12">
        ...
        <?php
            ...
            else if($dcMonActive || $dcPersonActive || $dcThresholdActive || $dcContactActive){
        ...
        <div class="panel-group" id="accordion">
            ...
            <div class="panel panel-default">
              ...
              <div id="collapseThree" class="list-group panel-collapse collapse <?php echo $dcOpen; ?>">
                ...
                <a href="javascript:{}" data-url="/insights/discover/contact/" class="insightLink list-group-item <?php echo $dcContactActive; ?>">Discover Contacts - Contact Summary</a>
              </div>
            </div>
            <div class="panel panel-default">
              <div class="panel-heading">
